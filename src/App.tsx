  ...
  return (
    <div className="flex flex-col h-screen h-[100dvh] bg-[#F2F2F7] text-foreground selection:bg-primary/20 font-sans antialiased overflow-hidden">
          ...
          <div className="flex items-center gap-2 md:gap-3 group cursor-pointer overflow-hidden">
            <div className="flex flex-col overflow-hidden">
              <h1 className="font-bold text-sm md:text-lg tracking-tight leading-none truncate uppercase">
                HONOR OF <span className="hidden sm:inline">CHESS</span>
              </h1>
      ...
      <div className="flex-1 flex overflow-hidden relative p-2 md:p-4 gap-2 md:gap-4">
        ...
        <div className={cn(
          "fixed md:relative inset-y-0 left-0 z-50 md:z-auto transition-transform duration-500 transform md:translate-x-0 w-[60%] max-w-[320px] md:w-80 h-full md:h-full md:shadow-none p-0 md:p-0",
